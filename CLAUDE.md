...
- Background work goes through `app/tasks.py` (`run_task(task, *args)`: Celery worker with `REDIS_URL`, a greenlet of the web process without); periodic jobs hang off `tick()`
