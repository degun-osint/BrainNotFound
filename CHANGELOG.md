...
- Deux conteneurs de plus (`redis`, `worker`, environ 140 Mo au total) : `docker compose up -d --build` les crée. Les journaux des corrections et des emails sont désormais dans `docker compose logs worker`.
